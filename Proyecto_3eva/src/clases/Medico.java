...
public class Medico extends Persona{
	...
	public static boolean controlNumColegiado(String tlf) {
		...
		if (tlf.matches(".*[0-9].*")==true && tlf.length()==9){
				...
				controlmovil=true;
			}//fin if numero maximo  9 cifras
			else {
			
				JOptionPane.showMessageDialog(null, "El numedo de colegiado debe tener 9 cifras");
				controlmovil=false;
			}//fin else telefono
		return controlmovil;	
	}// fin metodo control Telefono
